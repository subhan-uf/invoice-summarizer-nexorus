...
export async function sendSummaryEmail(invoice: any, summary: any, authenticatedSupabase?: any) {
  try {
    ...
    const summaryText = typeof summary === 'string' ? summary : generateSummaryText(summary);
...
export async function sendSummaryEmailToRecipient(invoice: any, summary: any, recipientEmail: string, authenticatedSupabase?: any) {
  try {
    // Create email content
    const emailSubject = `Summary of your invoice: ${invoice.name}`;
