...
export default function AboutPage() {
  return (
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center gap-10 py-24 md:py-40 px-6">
          <div className="inline-block w-full max-w-7xl text-center justify-center">
            ...
            <div className={subtitle({ class: "mt-6 max-w-4xl mx-auto text-lg" })}>
              Founded by Subhan Farooq, Nexorus Technologies is revolutionizing how businesses handle 
              invoice processing through intelligent automation and cutting-edge AI technology.
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <h3 className="text-2xl font-semibold text-primary mb-2">Subhan Farooq</h3>
                <p className="text-xl text-default-600 mb-6">Founder & CEO, Nexorus Technologies</p>
                <p className="text-default-600 leading-relaxed text-lg">
                  A passionate technologist and entrepreneur with a vision to transform how businesses 
                  handle their financial documents. With expertise in AI, machine learning, and 
                  enterprise software, Subhan leads Nexorus Technologies in creating innovative 
                  solutions that streamline invoice processing workflows.
                </p>
              </div>
      ...
      <section className="py-24 bg-gradient-to-br from-content1/20 to-background">
        <div className="container mx-auto w-full max-w-5xl px-6">
          <div className="text-center mb-20">
            ...
            <h2 className={title({ size: "lg" })}>Building the Future of Invoice Processing</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-default-600 leading-relaxed">
                      Founded in 2024, Nexorus Technologies was born from a simple observation: 
                      businesses were spending countless hours manually processing invoices, a task 
                      that was both time-consuming and error-prone. Our founder, Subhan Farooq, 
                      recognized the potential for AI to transform this critical business process.
                    </p>
                  </div>
                </div>
              </CardBody>
              ...
              <CardBody className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-default-600 leading-relaxed">
                      We developed AI Invoice Summarizer to automatically detect invoice emails, 
                      extract key information, and generate professional summaries. Our technology 
                      processes invoices in seconds, not hours, while maintaining the highest 
    ...
    <div>
                    ...
                    <p className="text-default-600 leading-relaxed">
                      Today, Nexorus Technologies serves businesses worldwide, helping them 
                      streamline their invoice processing workflows. Our mission is to empower 
                      businesses with intelligent automation that saves time, reduces errors, 
      ...
      <section className="py-24 bg-content1/20">
        <div className="container mx-auto w-full max-w-7xl px-6">
          <div className="text-center mb-20">
            ...
            <p className={subtitle({ class: "mt-6 max-w-3xl mx-auto text-lg" })}>
              The principles that guide our innovation and customer relationships
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-content1/50 backdrop-blur-sm border-1 border-divider/50 hover:border-primary/30 transition-all duration-300">
              <CardBody className="p-8 text-center">
                ...
                <p className="text-default-600 leading-relaxed">
                  We strive for excellence in everything we do, from product development to 
                  customer support, ensuring the highest quality experience for our users.
                </p>
              </CardBody>
            </Card>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-background to-content1/20">
        <div className="container mx-auto w-full max-w-7xl px-6">
          <div className="text-center mb-20">
            ...
            <h2 className={title({ size: "lg" })}>The Minds Behind the Innovation</h2>
            <p className={subtitle({ class: "mt-6 max-w-3xl mx-auto text-lg" })}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-content1/50 backdrop-blur-sm border-1 border-divider/50">
              <CardBody className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">AI Engineering Team</h3>
                <p className="text-secondary font-medium mb-4">Machine Learning Engineers</p>
                <p className="text-default-600 text-sm leading-relaxed">
                  Expert team developing cutting-edge AI algorithms for invoice processing 
            ...
            <Card className="bg-content1/50 backdrop-blur-sm border-1 border-divider/50">
              <CardBody className="p-8 text-center">
                ...
                <p className="text-success font-medium mb-4">Product & Design</p>
                <p className="text-default-600 text-sm leading-relaxed">
                  Dedicated team creating intuitive user experiences and ensuring our 
      ...
      <section className="py-24 bg-gradient-to-br from-primary/10 via-secondary/10 to-primary/10">
        <div className="container mx-auto w-full max-w-7xl px-6 text-center">
          <h2 className={title({ size: "lg" })}>Join Us in Transforming Business</h2>
          <p className={subtitle({ class: "mt-6 mb-10 text-lg" })}>
            Experience the future of invoice processing with AI Invoice Summarizer
          </p>
