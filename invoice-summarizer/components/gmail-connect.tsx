  ...
  const handleDisconnectGmail = async () => {
    try {
      ...
      if (result.success) {
        ...
        toast.error(
          result.error || "Failed to disconnect Gmail. Please try again.",
        );
      }
    } catch (error) {
            ...
            <CardBody className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="h-3 bg-default-200 rounded w-1/2 mt-2" />
                </div>
              </div>
            </CardBody>
          </Card>
        ) : (
          <Button disabled className="w-full" variant="bordered">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-default-500">
                      {userEmail
                        ? `Scanning ${userEmail} for invoices`
